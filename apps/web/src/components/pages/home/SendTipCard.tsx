...
export const SendTipCard = () => {
  return (
    <div className="rounded-[30px] bg-[linear-gradient(302.76deg,#FFFFFF_30.51%,#B8ACFF_106.11%)] h-[94px] p-5 border flex justify-between border-[#DADADA] bg-[linear-gradient(302.76deg,#FFFFFF_30.51%,#B8ACFF 106.11%)]">
