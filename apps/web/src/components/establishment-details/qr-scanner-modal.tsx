            ...
            <div className="space-y-4">
              {state === "success" && (
                <div className="p-4 border border-green-200 bg-green-50 rounded-lg text-center">
                  <div className="text-green-700 font-medium">Bonus Granted Successfully!</div>
                  <div className="text-green-600 text-sm mt-1">Closing...</div>
                </div>
              )}
              ...
              {(state === "scanned" || state === "granting") && (
                <div className="p-4 border border-green-200 bg-green-50 rounded-lg text-center">
                  <div className="text-green-700 font-medium">QR Code Scanned!</div>
